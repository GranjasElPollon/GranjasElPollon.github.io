document.getElementById("enviar-tres").addEventListener("click", function () {
    ...
    let url =
        ...
        "*PEDIDO%20DE%20LA%20WEB%20GRANJAS%20EL%20POLLON*%0A%0A*Mi%20nombre%20es*%3A%20" + nombret + "%0A%0A*Cantidad*%3A%20" + cartonest + "%20huevos%20por%20favor%0A%0A*Fecha%20de%20Entrega*%3A%20"+diat +"%0A%0AFeliz%20Dia%20%3A)%0A";
